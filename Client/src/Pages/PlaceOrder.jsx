  ...
  const onSubmitHandler = async (e) => {
      ...
      try {
        ...
        switch (method) {
          ...
          case 'stripe':
            const responseStripe = await axios.post(backendURL + '/api/order/place-order-stripe', orderData, {headers: {token}});
          ...
          case 'razorpay':
            const responseRazorpay = await axios.post(backendURL + '/api/order/place-order-razorpay', orderData, {headers: {token}});
        ...
        <div className='mt-8'>
          ...
          <div className='mt-12'>
            ...
            <div className='w-full text-end mt-8'>
              <button type='submit' className='bg-black text-white px-16 py-3 text-sm cursor-pointer active:scale-95'>PLACE ORDER</button>
            </div>
          </div>
        </div>
    </form> 
